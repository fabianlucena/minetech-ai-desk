...
export { default as BanIcon } from './ban.icon.jsx';
...
export { default as MessageDeliveredIcon } from './message-delivered.icon.jsx';
export { default as MessageFailedIcon } from './message-failed.icon.jsx';
export { default as MessageReadIcon } from './message-read.icon.jsx';
export { default as MessageSentIcon } from './message-sent.icon.jsx';
export { default as MessageWaitingIcon } from './message-waiting.icon.jsx';
...
export { default as UnbanIcon } from './unban.icon.jsx';
